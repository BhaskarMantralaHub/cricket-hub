    ...
    <>
      <header className="sticky top-0 z-40 flex items-center justify-between border-b border-[var(--border)] bg-[var(--surface)]/80 px-4 py-3 backdrop-blur-md">
        ...
        <Link href="/" className="group flex items-center gap-2">
          <span className="bg-gradient-to-r from-[var(--orange)] to-[var(--red)] bg-clip-text text-lg font-bold tracking-tight text-transparent transition-opacity group-hover:opacity-80">
            Cricket Hub
          </span>
        </Link>
